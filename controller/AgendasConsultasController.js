        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        agenda = _a.sent();
                        return [4 /*yield*/, connection.manager.query('select DataAgenda as dataAgenda, Hora as hora,PacienteNome as pacienteNome,FaseAtendimento as faseAtendimento,Observacao as observacao from AgendasConsultas a where a.ProfissionaisAgendasId = ' + agenda.id + ' and PacienteId = ' + request.params.id + ' and DataExclusao is null order by dataAgenda desc')];
                    case 2:
                        ret = _a.sent();
                        return [2 /*return*/, ret];
                }
