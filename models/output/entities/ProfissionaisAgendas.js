...
var ProfissionaisAgendas = /** @class */ (function () {
    ...
    __decorate([
        typeorm_1.Column("varchar", { name: "NomeAgenda", length: 80 }),
        __metadata("design:type", String)
    ], ProfissionaisAgendas.prototype, "nomeAgenda", void 0);
    __decorate([
        typeorm_1.Column("int", { name: "PermitirEncaixe", nullable: true }),
        __metadata("design:type", Number)
    ], ProfissionaisAgendas.prototype, "permitirEncaixe", void 0);
    __decorate([
        typeorm_1.Column("int", { name: "UsarOrdemChegada", nullable: true }),
        __metadata("design:type", Number)
    ...
    __decorate([
        typeorm_1.ManyToOne(function () { return Profissionais_1.Profissionais; }, function (profissionais) { return profissionais.profissionaisAgendas; }),
    ...
    __decorate([
        typeorm_1.ManyToOne(function () { return Usuarios_1.Usuarios; }, function (usuarios) { return usuarios.profissionaisAgendas; }),
        typeorm_1.JoinColumn([{ name: "UsuarioId", referencedColumnName: "id" }]),
        __metadata("design:type", Usuarios_1.Usuarios)
    ], ProfissionaisAgendas.prototype, "usuario", void 0);
    __decorate([
        typeorm_1.ManyToOne(function () { return Usuarios_1.Usuarios; }, function (usuarios) { return usuarios.profissionaisAgendas2; }),
    ...
    __decorate([
        typeorm_1.OneToMany(function () { return SalasAplicacoes_1.SalasAplicacoes; }, function (salasAplicacoes) { return salasAplicacoes.profissionaisAgendas; }),
        __metadata("design:type", Array)
    ...
    ProfissionaisAgendas = __decorate([
        typeorm_1.Index("PK_ProfissionaisAgendas", ["id"], { unique: true }),
        typeorm_1.Entity("ProfissionaisAgendas", { schema: "dbo" })
