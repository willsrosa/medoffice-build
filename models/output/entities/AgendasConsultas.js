...
var AgendasConsultas = /** @class */ (function () {
    ...
    __decorate([
        typeorm_1.Column("int", { name: "Sequencia", nullable: true }),
        __metadata("design:type", Number)
    ...
    __decorate([
        typeorm_1.Column("char", { name: "Hora", length: 4 }),
        __metadata("design:type", String)
    ], AgendasConsultas.prototype, "hora", void 0);
    __decorate([
        typeorm_1.Column("int", { name: "TipoAtendimento", nullable: true }),
        __metadata("design:type", Number)
    ...
    __decorate([
        typeorm_1.Column("varchar", { name: "FoneContato", length: 40 }),
        __metadata("design:type", String)
    ], AgendasConsultas.prototype, "foneContato", void 0);
    __decorate([
        typeorm_1.Column("smalldatetime", { name: "Confirmado", nullable: true }),
        __metadata("design:type", Date)
    ...
    __decorate([
        typeorm_1.Column("smalldatetime", { name: "DataReagendada", nullable: true }),
        __metadata("design:type", Date)
    ], AgendasConsultas.prototype, "dataReagendada", void 0);
    __decorate([
        typeorm_1.Column("varchar", { name: "MotivoCancelamento", nullable: true, length: 80 }),
        __metadata("design:type", String)
    ...
    __decorate([
        typeorm_1.Column("varchar", { name: "Observacao", nullable: true, length: 200 }),
        __metadata("design:type", String)
    ], AgendasConsultas.prototype, "observacao", void 0);
    __decorate([
        typeorm_1.Column("int", { name: "ConvenioId", nullable: true }),
        __metadata("design:type", Number)
    ], AgendasConsultas.prototype, "convenioId", void 0);
    __decorate([
        typeorm_1.Column("varchar", { name: "Vinculo", nullable: true, length: 128 }),
        __metadata("design:type", String)
    ...
    __decorate([
        typeorm_1.ManyToOne(function () { return Usuarios_1.Usuarios; }, function (usuarios) { return usuarios.agendasConsultas; }),
        typeorm_1.JoinColumn([{ name: "UsuarioAgendamento", referencedColumnName: "id" }]),
        __metadata("design:type", Usuarios_1.Usuarios)
    ], AgendasConsultas.prototype, "usuarioAgendamento", void 0);
    __decorate([
        typeorm_1.ManyToOne(function () { return Usuarios_1.Usuarios; }, function (usuarios) { return usuarios.agendasConsultas2; }),
        typeorm_1.JoinColumn([{ name: "UsuarioCancelamento", referencedColumnName: "id" }]),
        __metadata("design:type", Usuarios_1.Usuarios)
    ], AgendasConsultas.prototype, "usuarioCancelamento", void 0);
    __decorate([
        typeorm_1.ManyToOne(function () { return Usuarios_1.Usuarios; }, function (usuarios) { return usuarios.agendasConsultas3; }),
    ...
    AgendasConsultas = __decorate([
        typeorm_1.Index("PK_AGENDASCONSULTAS", ["id"], { unique: true }),
        typeorm_1.Entity("AgendasConsultas", { schema: "dbo" })
    ], AgendasConsultas);
