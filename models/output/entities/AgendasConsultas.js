...
var AgendasConsultas = /** @class */ (function () {
    ...
    __decorate([
        (0, typeorm_1.Column)("varchar", { name: "Observacao", nullable: true, length: 200 }),
        __metadata("design:type", String)
    ...
    __decorate([
        (0, typeorm_1.Column)("varchar", { name: "Vinculo", nullable: true, length: 128 }),
        __metadata("design:type", String)
    ...
    __decorate([
        (0, typeorm_1.ManyToOne)(function () { return ProfissionaisAgendas_1.ProfissionaisAgendas; }, function (profissionaisAgendas) { return profissionaisAgendas.agendasConsultas; }),
    ...
    __decorate([
        (0, typeorm_1.ManyToOne)(function () { return Pacientes_1.Pacientes; }, function (pacientes) { return pacientes.agendasConsultas; }),
