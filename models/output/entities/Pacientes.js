...
var Pacientes = /** @class */ (function () {
    ...
    __decorate([
        typeorm_1.Column("char", { name: "Cpf", nullable: true, length: 11 }),
        __metadata("design:type", String)
    ...
    __decorate([
        typeorm_1.Column("char", { name: "Prontuario", nullable: true, length: 20 }),
        __metadata("design:type", String)
    ], Pacientes.prototype, "prontuario", void 0);
    __decorate([
        typeorm_1.Column("varchar", { name: "Indicacao", nullable: true, length: 50 }),
        __metadata("design:type", String)
    ...
    __decorate([
        typeorm_1.Column("varchar", { name: "NomeMae", nullable: true, length: 80 }),
        __metadata("design:type", String)
    ...
    __decorate([
        typeorm_1.Column("varchar", { name: "Complemento", nullable: true, length: 30 }),
        __metadata("design:type", String)
    ], Pacientes.prototype, "complemento", void 0);
    __decorate([
        typeorm_1.Column("varchar", { name: "Bairro", nullable: true, length: 100 }),
        __metadata("design:type", String)
    ...
    __decorate([
        typeorm_1.Column("char", { name: "Sexo", nullable: true, length: 1 }),
        __metadata("design:type", String)
    ], Pacientes.prototype, "sexo", void 0);
    __decorate([
        typeorm_1.Column("int", { name: "EstadoCivil", nullable: true }),
        __metadata("design:type", Number)
    ...
    __decorate([
        typeorm_1.Column("char", { name: "Cid", nullable: true, length: 8 }),
        __metadata("design:type", String)
    ], Pacientes.prototype, "cid", void 0);
    __decorate([
        typeorm_1.Column("decimal", { name: "Altura", nullable: true, precision: 5, scale: 2 }),
        __metadata("design:type", Number)
    ], Pacientes.prototype, "altura", void 0);
    __decorate([
        typeorm_1.Column("decimal", { name: "Peso", nullable: true, precision: 7, scale: 3 }),
        __metadata("design:type", Number)
    ], Pacientes.prototype, "peso", void 0);
    __decorate([
        typeorm_1.Column("int", { name: "CorPele", nullable: true }),
        __metadata("design:type", Number)
    ...
    __decorate([
        typeorm_1.Column("varchar", { name: "Email", nullable: true, length: 80 }),
        __metadata("design:type", String)
    ...
    __decorate([
        typeorm_1.Column("varchar", { name: "Mae", nullable: true, length: 80 }),
        __metadata("design:type", String)
    ], Pacientes.prototype, "mae", void 0);
    __decorate([
        typeorm_1.Column("varchar", { name: "Carteirinha", nullable: true, length: 30 }),
        __metadata("design:type", String)
    ], Pacientes.prototype, "carteirinha", void 0);
    __decorate([
        typeorm_1.Column("varchar", { name: "Observacoes", nullable: true, length: 2000 }),
        __metadata("design:type", String)
    ], Pacientes.prototype, "observacoes", void 0);
    __decorate([
        typeorm_1.Column("int", { name: "Escolaridade", nullable: true }),
        __metadata("design:type", Number)
    ], Pacientes.prototype, "escolaridade", void 0);
    __decorate([
        typeorm_1.Column("int", { name: "TipoSanguineo", nullable: true }),
        __metadata("design:type", Number)
    ], Pacientes.prototype, "tipoSanguineo", void 0);
    __decorate([
        typeorm_1.Column("varchar", { name: "Plano", nullable: true, length: 100 }),
        __metadata("design:type", String)
    ...
    __decorate([
        typeorm_1.ManyToOne(function () { return Usuarios_1.Usuarios; }, function (usuarios) { return usuarios.pacientes; }),
    ...
    Pacientes = __decorate([
        typeorm_1.Index("PK_PACIENTES", ["id"], { unique: true }),
        typeorm_1.Entity("Pacientes", { schema: "dbo" })
    ], Pacientes);
    return Pacientes;
}());
