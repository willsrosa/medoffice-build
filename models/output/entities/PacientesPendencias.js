...
var PacientesPendencias = /** @class */ (function () {
    ...
    __decorate([
        typeorm_1.Column("int", { name: "Tipo", nullable: true }),
        __metadata("design:type", Number)
    ], PacientesPendencias.prototype, "tipo", void 0);
    __decorate([
        typeorm_1.Column("varchar", { name: "Obs", nullable: true, length: 500 }),
    ...
    PacientesPendencias = __decorate([
        typeorm_1.Index("PK_PACIENTESPENDENCIAS", ["id"], { unique: true }),
        typeorm_1.Entity("PacientesPendencias", { schema: "dbo" })
    ], PacientesPendencias);
