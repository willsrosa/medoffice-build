...
var Permissoes = /** @class */ (function () {
    ...
    __decorate([
        typeorm_1.OneToMany(function () { return UsuariosPermissoes_1.UsuariosPermissoes; }, function (usuariosPermissoes) { return usuariosPermissoes.permissao; }),
        __metadata("design:type", Array)
    ], Permissoes.prototype, "usuariosPermissoes", void 0);
    Permissoes = __decorate([
        typeorm_1.Index("PK_PERMISSOES", ["id"], { unique: true }),
        typeorm_1.Entity("Permissoes", { schema: "dbo" })
    ], Permissoes);
    return Permissoes;
}());
