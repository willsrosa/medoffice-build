...
var Pacientes = /** @class */ (function () {
    ...
    __decorate([
        typeorm_1.Column("char", { name: "Cpf", length: 11 }),
        __metadata("design:type", String)
    ...
    __decorate([
        typeorm_1.Column("varchar", { name: "Observacoes", nullable: true, length: 300 }),
        __metadata("design:type", String)
    ...
    __decorate([
        typeorm_1.ManyToOne(function () { return Usuarios_1.Usuarios; }, function (usuarios) { return usuarios.pacientes2; }),
