...
var Pacientes = /** @class */ (function () {
    ...
    __decorate([
        (0, typeorm_1.Column)("char", { name: "Cpf", length: 11 }),
        __metadata("design:type", String)
    ...
    __decorate([
        (0, typeorm_1.Column)("varchar", { name: "Carteirinha", nullable: true, length: 15 }),
        __metadata("design:type", String)
    ...
    __decorate([
        (0, typeorm_1.Column)("varchar", { name: "Observacoes", nullable: true, length: 300 }),
        __metadata("design:type", String)
    ...
    __decorate([
        (0, typeorm_1.Column)("int", { name: "Escolaridade" }),
        __metadata("design:type", Number)
    ], Pacientes.prototype, "escolaridade", void 0);
    __decorate([
        (0, typeorm_1.Column)("int", { name: "TipoSanguineo" }),
        __metadata("design:type", Number)
    ...
    __decorate([
        (0, typeorm_1.ManyToOne)(function () { return Convenios_1.Convenios; }, function (convenios) { return convenios.pacientes; }, { eager: true }),
    ...
    __decorate([
        (0, typeorm_1.ManyToOne)(function () { return Usuarios_1.Usuarios; }, function (usuarios) { return usuarios.pacientes2; }),
