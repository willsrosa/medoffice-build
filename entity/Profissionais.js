...
var Profissionais = /** @class */ (function () {
    ...
    __decorate([
        typeorm_1.Column("char", { name: "Complemento", nullable: true, length: 20 }),
        __metadata("design:type", String)
    ...
    __decorate([
        typeorm_1.Column("int", { name: "ConselhoProfissional", nullable: true }),
        __metadata("design:type", Number)
    ...
    __decorate([
        typeorm_1.ManyToOne(function () { return Usuarios_1.Usuarios; }, function (usuarios) { return usuarios.profissionais2; }),
        typeorm_1.JoinColumn([{ name: "UsuarioExclusao", referencedColumnName: "id" }]),
        __metadata("design:type", Usuarios_1.Usuarios)
    ], Profissionais.prototype, "usuarioExclusao", void 0);
    __decorate([
        typeorm_1.OneToMany(function () { return ProfissionaisAgendas_1.ProfissionaisAgendas; }, function (profissionaisAgendas) { return profissionaisAgendas.profissional; }),
        __metadata("design:type", Array)
    ], Profissionais.prototype, "profissionaisAgendas", void 0);
    __decorate([
        typeorm_1.OneToMany(function () { return ProfissionaisConvenios_1.ProfissionaisConvenios; }, function (profissionaisConvenios) { return profissionaisConvenios.profissional; }),
        __metadata("design:type", Array)
    ], Profissionais.prototype, "profissionaisConvenios", void 0);
    Profissionais = __decorate([
        typeorm_1.Index("PK_PROFISSIONAIS", ["id"], { unique: true }),
        typeorm_1.Entity("Profissionais", { schema: "dbo" })
    ], Profissionais);
