...
var ProfissionaisConvenios = /** @class */ (function () {
    ...
    __decorate([
        typeorm_1.Column("int", { name: "LimiteAgendamentosDiarios", nullable: true }),
        __metadata("design:type", Number)
    ], ProfissionaisConvenios.prototype, "limiteAgendamentosDiarios", void 0);
    __decorate([
        typeorm_1.Column("int", { name: "LimiteAgendamentosMensais", nullable: true }),
        __metadata("design:type", Number)
    ...
    __decorate([
        typeorm_1.ManyToOne(function () { return Convenios_1.Convenios; }, function (convenios) { return convenios.profissionaisConvenios; }, { eager: true }),
    ...
    __decorate([
        typeorm_1.ManyToOne(function () { return Usuarios_1.Usuarios; }, function (usuarios) { return usuarios.profissionaisConvenios; }),
        typeorm_1.JoinColumn([{ name: "UsuarioId", referencedColumnName: "id" }]),
        __metadata("design:type", Usuarios_1.Usuarios)
    ], ProfissionaisConvenios.prototype, "usuario", void 0);
    __decorate([
        typeorm_1.ManyToOne(function () { return Usuarios_1.Usuarios; }, function (usuarios) { return usuarios.profissionaisConvenios2; }),
    ...
    ProfissionaisConvenios = __decorate([
        typeorm_1.Index("PK_ProfissionaisConvenios", ["id"], { unique: true }),
        typeorm_1.Entity("ProfissionaisConvenios", { schema: "dbo" })
