...
var ListaEspera = /** @class */ (function () {
    ...
    __decorate([
        typeorm_1.Column("int", { name: "ProfissionalAgendaId", nullable: true }),
        __metadata("design:type", Number)
    ], ListaEspera.prototype, "profissionalAgendaId", void 0);
    __decorate([
        typeorm_1.Column("varchar", { name: "Paciente", nullable: true, length: 60 }),
    ...
    __decorate([
        typeorm_1.Column("varchar", { name: "Celular", nullable: true, length: 20 }),
        __metadata("design:type", String)
    ], ListaEspera.prototype, "celular", void 0);
    __decorate([
        typeorm_1.Column("varchar", { name: "Observacao", nullable: true, length: 1000 }),
        __metadata("design:type", String)
    ...
    __decorate([
        typeorm_1.Column("smalldatetime", { name: "DataAgendamento", nullable: true }),
        __metadata("design:type", Date)
    ...
    ListaEspera = __decorate([
        typeorm_1.Index("PK_ListaEspera", ["id"], { unique: true }),
        typeorm_1.Entity("ListaEspera", { schema: "dbo" })
    ], ListaEspera);
    return ListaEspera;
}());
